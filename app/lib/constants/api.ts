...
const _adminPaths = {
  ...
  ATTRIBUTES_BY_PRODUCT_ID: 'attributes/product/:productId',
  CREATE_ATTRIBUTE_VALUE: 'attributes/:id/create',
  DELETE_ATTRIBUTE_VALUE: 'attributes/:id/remove/:valueId',
  UPDATE_ATTRIBUTE_VALUE: 'attributes/:id/update/:valueId',
  BRANDS: 'brands',
  BRAND: 'brands/:id',
  ...
  PRODUCTS: 'products',
  PRODUCT_DETAIL: 'products/:id',
  PRODUCT_VARIANTS: 'products/:productId/variants',
  PRODUCT_VARIANT_BY_ID: 'products/:productId/variants/:variantId',
  VARIANT_IMAGE_UPLOAD: 'products/:productId/variants/:variantId/images',
  PRODUCT_IMAGES_UPLOAD: 'products/:productId/images',
